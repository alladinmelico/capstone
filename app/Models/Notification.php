...
class Notification extends DatabaseNotification
{
    ...
    /**
     * The admin actor of the notification
     *
     */
    public function adminActor()
    {
        return $this->belongsTo(Admin::class, 'data->actor_id');
    }
    ...
    /**
     * Returns specific types notifications
     *
     * @param Builder $query
     * @return void
     */
    ...
    /**
     * Returns notifications except for the excluded type
     *
     * @param Builder $query
     * @return void
     */
    public function scopeTypeExclude(Builder $query, string $type)
    {
